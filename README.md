...
For static maps, check out [Mapkick Static](https://github.com/ankane/mapkick-static.py), and for charts, check out [Chartkick.py](https://github.com/ankane/chartkick.py)
